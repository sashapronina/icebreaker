  ...
  return (
    ...
    >
      <button
        ...
        style={{ color: '#FF6D50', width: 32, height: 32, fontSize: 32 }}
        aria-label="Close"
      >
        ×
      </button>
      ...
      <div className="max-w-lg w-full text-left">
        ...
        <p className="font-body font-medium text-base mb-6" style={{ color: '#FF6D50' }}>
          I hope you enjoyed this unassuming nibble of experience.
        </p>
        <p className="font-body font-medium text-base leading-relaxed" style={{ color: '#FF6D50' }}>
          In the meantime,{' '}
